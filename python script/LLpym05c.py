...
for i, line in enumerate(file):
    ...
    if isinstance(current_game[4], list) and isinstance(current_game[5], list):  # individual game lists contain 6 entries
...
create_plot(kd_trimmed, 'K/D Distribution (truncated at x = 3)', 'K/D (resolution: 0.01)', 'KD_Distribution (TRIMMED).png', 100, True)
